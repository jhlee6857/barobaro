...
export const mockCases = [
  {
    ...
    process: "기존 외주 업체 해지 후 바로 직영 청소 마스터 투입. 노후 배관 고압 세척 및 주차단속 시스템 재정비.",
  ...
  },
  {
    ...
    process: "1588 상황실 연동. 비상시 신속한 출동 체계 구축. 주 1회 전문 조경사 파견.",
...
export const faqData = [
  ...
  },
  {
    ...
    answer: "물론입니다. 바로건물관리는 대형 빌딩뿐만 아니라 소규모 빌라, 원룸 건물, 꼬마빌딩에 특화된 맞춤형 컴팩트 요금제를 제공하고 있습니다."
  },
  {
    id: "faq-3",
    question: "새벽에 배관이 터지는 등 응급 상황 발생 시 바로 조치가 되나요?",
    answer: "네, 당사 상황실로 연락 주시면, 해당 권역의 대기 중인 직영 기사가 즉각 출동하여 1차 응급 조치를 진행합니다."
  },
  {
    id: "faq-4",
