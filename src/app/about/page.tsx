          ...
          <div className="flex flex-col md:flex-row items-center gap-12 max-w-5xl mx-auto">
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                ...
                <p>과거의 건물관리는 단순한 유지보수와 청소 수준에 머무르는 수동적인 영역이었습니다. 그러나 현대의 건물은 소유주에게는 가치를 창출하는 핵심 자산이며, 이용자에게는 삶의 질을 좌우하는 중요한 프리미엄 공간입니다.</p>
                <p>저희 바로건물관리는 불투명한 하청 구조로 굳어진 기존 산업의 패러다임을 혁신하고자 출범했습니다. 각 분야의 국가 공인 자격을 갖춘 &apos;직영 마스터&apos;의 독보적인 전문성, 체계적인 IT 솔루션 기반의 투명한 데이터 관리, 그리고 체계적인 중앙 통제 시스템을 통한 신속한 대응력으로 공간 관리의 새로운 표준을 제시합니다.</p>
                <p>건물의 근본적인 문제 해결부터 자산 가치 상승까지, 바로건물관리가 그 해답을 제공하겠습니다. 타협 없는 서비스 품질과 결과로 증명해 보이겠습니다.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="text-center border-none shadow-sm pb-6">
              ...
              <CardContent>
                ...
                <p className="text-slate-500 text-sm">접수된 모든 민원과 하자는 신속하게 초동 대처하는 것을 원칙으로 합니다.</p>
              </CardContent>
            </Card>
            <Card className="text-center border-none shadow-sm pb-6">
              <div className="w-full h-32 bg-brand-light flex items-center justify-center mb-6 rounded-t-xl text-brand-primary">
